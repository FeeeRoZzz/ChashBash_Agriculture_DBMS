        ...
        <div class="content">
            ...
            <br>
                ...
                <div class="d-flex justify-content-center align-items-center" style="height: 6vh;">
                 <h5 class="text-center"> Hello , This is Our Products  </h5>
                   </div>
              ...
              <div class=" d-grid gap-2">
                <div class="d-grid gap-2">
              <a href="AddNewProduct.php" button class="btn btn-primary w-100 m-2"  type="button"> ADD NEW PRODUCTS </a> </button>
               </div>
                </div>
                 </div>
                  <br>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            <thead>
                                <tr class="text-dark">
                                    ...
                                    <th scope="col">Historical Price / Per KG </th>
                                    <th scope="col">Present Price / Per KG </th>
