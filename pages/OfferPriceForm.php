    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="col-sm-12 col-xl-6">
                ...
                <h1 class="mb-4"> OFFER PRICE SELECTION </h1>
                ...
                placeholder="">
                <label for="floatingInput">Enter Product Amount</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="" class="form-control" id="floatingInput"
                    placeholder="name@example.com">
                    <label for="floatingInput">Enter Offer Price </label>
                    </div>
                </div>
                <button type="submit" class="btn btn-primary">Send To AMR Officer </button>
            </form>
        </div>
