        ...
        <div class="content">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-lg-inline-flex">Feroz Mahmud</span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                <div class="mb-3">
                                    ...
                                    <input type="Product" class="form-control" id="ProductName"
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row vh-10 bg-light rounded align-items-center justify-content-center mx-0">
                <div class="mb-3">
                                    <label for="ProductName" class="form-label">Variety </label>
                                    <input type="Product" class="form-control" id="ProductName"
                                        aria-describedby="emailHelp">
                                    <div id="emailHelp" class="form-text">
                                    </div>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row vh-10 bg-light rounded align-items-center justify-content-center mx-0">
                <div class="mb-3">
                                    <label for="ProductName" class="form-label">Seasonality  </label>
                                    <input type="Product" class="form-control" id="ProductName"
                                        aria-describedby="emailHelp">
                                    <div id="emailHelp" class="form-text">
                                    </div>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row vh-10 bg-light rounded align-items-center justify-content-center mx-0">
                <div class="mb-3">
                                    <label for="ProductName" class="form-label">Historical Price (Per KG)  </label>
                                    <input type="Product" class="form-control" id="ProductName"
                                        aria-describedby="emailHelp">
                                    <div id="emailHelp" class="form-text">
                                    </div>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row vh-10 bg-light rounded align-items-center justify-content-center mx-0">
                <div class="mb-3">
                                    <label for="ProductName" class="form-label">Present  Price (Per KG)  </label>
                                    <input type="Product" class="form-control" id="ProductName"
                                        aria-describedby="emailHelp">
                                    <div id="emailHelp" class="form-text">
                                    </div>
