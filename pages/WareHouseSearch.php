        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    ...
                    <div class="ms-3">
                        <h6 class="mb-0">ARAFAT HOSSAIN</h6>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu bg-transparent border-0">
                                <a href="../pages/WareHouseProduct.html" class="dropdown-item"> PRODUCT LIST </a>
                            </div>
                    ...
                    <a href="../pages/WareHouseSearch.html" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>SEARCH</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="../pages/WarehouseManProfile.html" class="dropdown-item">PROFILE</a>
        ...
        <div class="content">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            ...
                            <hr class="dropdown-divider">
                            <a href="#" class="dropdown-item">
                                <h6 class="fw-normal mb-0">A nEw Mail</h6>
                                <small>15 minutes ago</small>
                            </a>
                            <hr class="dropdown-divider">
                            <a href="#" class="dropdown-item">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-lg-inline-flex">Arafat Hossain </span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
            ...
            <div class="col-sm-12 col-xl-6">
                ...
                <!-- <div class="form-floating mb-3">
                    ...
                    <option value="2">WHEATS</option>
                    <option value="3">RICE</option>
                    </select>
                    <label for="floatingSelect">What's Your Product ? </label>
                    </div>
                ...
                placeholder="">
                <label for="floatingInput">Enter Product ID</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="" class="form-control" id="floatingInput"
                    placeholder="">
                ...
                <div class="form-floating mb-3">
                    ...
                    <label for="floatingInput">Enter Warehouse ID </label>
                    </div>
                    ...
                    <div class="form-floating mb-3">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <div class="form-floating mb-3">
                                <input type="" class="form-control" id="floatingInput"
                                placeholder="">
                                <label for="floatingInput"> Enter Ammount </label>
                                </div>
    
                        <button type="submit" class="btn btn-primary">Update Storage  </button>
                        <button type="submit" class="btn btn-primary">Delete Storage  </button>
